...
import type { BabLinkKey } from "@/lib/types";

const linkIcons: Record<BabLinkKey | "reserve", string> = {
  booking: "🏨",
  googleMaps: "📍",
  restaurantMenu: "📋",
  instagram: "📸",
...
interface BabLinkButtonProps {
  linkKey: BabLinkKey | "reserve";
  href: string;
  label: string;
  primaryColor: string;
  internal?: boolean;
